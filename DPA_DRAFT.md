# Clikarage — Accord de sous-traitance RGPD (référence interne)
...
## 1. Objet
Encadre le traitement de données personnelles réalisé par RODANBTECH dans le cadre de la fourniture de Clikarage à un garage participant au pilote.
...
- **RODANBTECH** intervient comme sous-traitant technique (fourniture, maintenance, sécurisation de Clikarage), et peut être responsable de traitement pour ses propres comptes, la sécurité, la prospection éventuelle et la relation contractuelle avec le garage.
...
Traitement uniquement pour fournir Clikarage, selon les instructions documentées du garage, les conditions du pilote, les CGU, la politique de confidentialité et les besoins de sécurité du service.

## 8. Confidentialité
Pas de revente des données ; accès limité aux personnes/prestataires en ayant besoin pour fournir, maintenir ou sécuriser Clikarage.
