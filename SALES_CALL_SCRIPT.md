...
> Remplacez `[Prénom]`, `[Nom du garage]`, `[ville]`.

---

## 0. Demander la bonne personne (10 s)
> « Bonjour, je voudrais parler au responsable / au gérant du garage, s'il vous plaît ? »

## 1. Accroche (15 s)
> « Bonjour, je suis [Prénom]. Je ne vais pas vous déranger longtemps — deux minutes. J'aide des garages de [ville] à recevoir leurs demandes de rendez-vous et à gérer leurs devis en ligne. Je peux vous poser une question rapide ? »

*(attendre le oui)*

## 2. Problème (20 s)
> « En ce moment, vos demandes de rendez-vous, elles arrivent surtout par téléphone et au comptoir, c'est ça ? … Et les devis, vous les faites comment, sur papier ou Excel ? »
...
## 5. Proposition de démo (15 s)
> « Je cherche quelques garages pilotes pour le tester **gratuitement 30 jours**, je m'occupe du paramétrage. Le mieux, c'est que je vous montre en **10 minutes**. Vous préférez **demain matin** ou plutôt **en fin de journée** ? »

*(proposer deux créneaux, pas « êtes-vous dispo » — laisser choisir entre A et B)*

## 6. Clôture
> « Parfait, je note [jour / heure]. Je vous envoie un SMS de rappel avec le lien. À bientôt ! »
...
**« Envoyez-moi un mail. »**
> « Avec plaisir, je vous l'envoie tout de suite. Pour que ce ne soit pas un mail de plus qui se perd, je vous rappelle juste **2 minutes [jour]** pour vous montrer en direct — ça parle beaucoup plus qu'un mail. Ça vous va si je vous rappelle [jour, heure] ? »
> *(récupérer l'e-mail, puis tenter de fixer le rappel)*

---

## Rappels
- **Écouter plus que parler.** Les objections sont des infos : notez-les.
- **Toujours proposer 2 créneaux** plutôt qu'une question ouverte.
- **Ne pas négocier le prix au téléphone** : renvoyer à la démo / au pilote.
- Après l'appel : envoyer **immédiatement** le SMS/mail de confirmation (voir `SALES_OUTREACH.md`).
